...
- ID: A115435
- Foto: <img src="foto_autor.png" alt="Foto do autor" width="100">

## Resumo

- Crie um programa em Python para jogar o jogo "Adivinha o número":
    - O jogo pode ter 2 modalidades:
      1) computador pensa num número (entre 0 e 100) e o utilizador tenta adivinhar;
